...
def extract_planes(cur_game_state, next_game_state, features=DEFAULT_FEATURES):
    return np.concatenate([feature(cur_game_state) for feature in features] + [feature(next_game_state) for feature in features], axis=2)
